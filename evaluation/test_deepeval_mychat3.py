...
conciseness = GEval(
    name="Conciseness",
    criteria="Determine how concise the actual output is based on the input, assessing whether the response delivers only the essential information needed to address the query without unnecessary detail or redundancy.",
    evaluation_params=[LLMTestCaseParams.INPUT, LLMTestCaseParams.ACTUAL_OUTPUT],
)
...
metrics = [correctness_ai, conciseness, answerRelevancy]
